...
import br.edu.iftm.ppi.services.OrcamentoService;

@RestController
@RequestMapping(value="/orcamentos")
public class OrcamentoResources {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody Orcamento obj){
		...
		Orcamento obj1 = service.insert(obj);
...
//	public ResponseEntity<Void> update(@Valid @RequestBody Orcamento obj, @PathVariable Integer id){
